...
""")
    ...
    selected = option_menu(
        menu_title=None,
        options=["탑승자 데이터 검색", "전체 생존/사망 비율", "성별/객실 생존 분석", "예측 모델 정확도"],
        icons=["search", "heart-pulse", "bar-chart", "cpu"],
        menu_icon="cast",
        default_index=0,
    ...
    if selected == "전체 생존/사망 비율":
        st.markdown("<p style='font-size:20px; font-weight:bold; color:#373737'>✅ 생존자 / 사망자 수</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='font-size:20px; font-weight:bold; color:#373737'>🧠 생존 예측 모델 정확도</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='font-size:20px; font-weight:bold; color:#373737'>🔎 탑승자 데이터 검색</p>", unsafe_allow_html=True)
